...
const requestQuery = (state, action) => {
...
const receiveQueryError = (state, action) => {
...
const receiveQuery = (state, action) => {
...
const invalidateQuery = (state, action) => {
  const key = action.payload;
